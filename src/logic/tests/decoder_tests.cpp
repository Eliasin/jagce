...
TEST_CASE("decoder produces correct events", "[logic], [decoder]") {
	...
	SECTION("loads with partial addresses") {
	...
	SECTION("register/indirect to indirect/register load instruction decodes") {
		uint8_t opcode = GENERATE(0x02, 0x12, 0x22, 0x2A, 0x32, 0x3A, 0x7F, 0x77, 0x78, 0x79, 0x7A, 0x7B, 0x7C, 0x7D, 0x7E, 0x40, 0x41, 0x42, 0x43, 0x44,
				...
				0x69, 0x6A, 0x6B, 0x6C, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x0A, 0x1A, 0x7E);
